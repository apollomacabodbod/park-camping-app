  ...
  return (<>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 mt-[3.989375em] gap-[1.875em] mb-[4.6175em]">
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/family-camping.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/friends-cooking.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/friends-having.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/tourist-camp.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/tourist-couple.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
      ...
      <div className="flex flex-col ">
        ...
        <motion.img src="/tourists-go.jpg" alt="" className="h-[12.5em] object-cover rounded-[0.25em] transition-all duration-1000 ease-in-out"
