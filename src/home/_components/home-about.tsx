...
export default function HomeAbout(){
  ...
  return(<>
    ...
    <div className="flex flex-col bg-[rgba(16,34,29,0.60)] pt-[5em] lg:pt-[9.095em] pb-[9.905em] px-[1.25em] lg:pl-[10em] max-w-[1200px]   " >
      ...
      <motion.p className="text-white font-roboto text-[2.25rem] not-italic font-semibold leading-[1em] mt-[0.2em] transition-all duration-1000 ease-in-out"
      ...
      <motion.p className="text-white font-inter text-[0.9375rem] not-italic font-normal mt-[1em] transition-all duration-1000 ease-in-out"
...
faucibus dolor non semper leo quis. Pretium quam lacus.</motion.p>
      ...
      <motion.p className="text-white font-inter text-[0.9375rem] mt-[2em] not-italic font-normal transition-all duration-1000 ease-in-out"
