...
export default function HomeDeals(){
  ...
  return(<>
    ...
    <div className="flex flex-col mt-[6.25em] border border-[#50B498] green">
      ...
      <p className="text-[#333] text-center font-roboto text-[2.25rem] not-italic font-semibold ">Super Mega Deals</p>

      <p className="text-[#333] font-roboto text-[0.9375rem] not-italic font-normal text-center mt-[2em]">Nullam semper etiam congue lacinia nuncesit quam vel vestibulum<br></br>
