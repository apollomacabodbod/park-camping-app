...
export default function CampingFeatured(){
  ...
  return(<>
    ...
    <div className="flex flex-col mt-[6.25em] ">
      ...
      >
        ...
        <p className="text-[#CA6702] leading-normal font-open-sans tracking-[0.125em] text-[0.9375rem] not-italic font-bold uppercase">featured</p>
