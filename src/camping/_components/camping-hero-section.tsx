...
export default function CampingHeroSection(){
  ...
  return(<>
    ...
    <div className="z-10 flex flex-col max-w-[1200px] lg:mx-auto px-[1.25em] my-[9em] ">
      ...
      >
        ...
        <Link to={"/camping"} className="text-white font-roboto text-[0.9375rem] not-italic font-bold uppercase"> destination spots</Link>
